<%@ Page Title="" Language="C#" MasterPageFile="~/PoliceStaff.Master" AutoEventWireup="true" CodeBehind="PoliceStaffViewCrimeInvestigationLog.aspx.cs" Inherits="CloudBasedEncryptedCrime.PoliceStaffViewCrimeInvestigationLog" %>
...
<div class="forms">
        ...
        <div class="form-grids row widget-shadow" data-example-id="basic-forms">
            <div class="form-title">
                <h4>
                    View Crime Investigation Log Details:</h4>
            </div>
            <div class="form-body">

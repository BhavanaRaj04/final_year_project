<%@ Page Title="" Language="C#" MasterPageFile="~/PoliceStation.Master" AutoEventWireup="true" CodeBehind="PoliceStationViewEvidenceLog.aspx.cs" Inherits="CloudBasedEncryptedCrime.PoliceStationViewEvidenceLog" %>
...
<div class="forms">
        ...
        <div class="form-grids row widget-shadow" data-example-id="basic-forms">
            <div class="form-title">
                <h4>
                    View Crime Evidence Log Details:</h4>
            </div>
            <div class="form-body">
